...
checks=(
	"res://tests/town_interior_lazy_loading_test.gd|TOWN_INTERIOR_LAZY_LOADING_PASS|215"
	...
	"res://tests/interior_occlusion_asset_generator_test.gd|INTERIOR_OCCLUSION_ASSET_GENERATOR_PASS|53"
