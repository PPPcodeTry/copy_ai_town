...
- 本次预发行包同时提供 Windows、macOS 和 Android 三个平台版本。
- 修复 Android 输入框进入页面时自动弹出键盘的问题，短按才会唤起当前系统输入法，长按使用系统原生的剪切、复制、粘贴和全选菜单。
- 修复平板和折叠屏下居民、地点总览文字与头像错位或消失的问题，列表条目保持统一比例并继续支持触控滑动。
- 启用 Android 触控到桌面控件的点击转换，保留桌面端现有鼠标、键盘和输入逻辑不变。
